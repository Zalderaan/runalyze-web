...
export async function GET(
    ...
    try {
        ...
        const flattenedData = {
            ...
            duration_seconds: data.videos?.[0]?.duration_seconds,
            fps: data.videos?.[0]?.fps,
            resolution: data.videos?.[0]?.resolution,
            total_frames: data.videos?.[0]?.total_frames,
            analyzed_frames: data.videos?.[0]?.analyzed_frames,
            file_size_mb: data.videos?.[0]?.file_size_mb,
            detailed_feedback,
